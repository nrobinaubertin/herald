...
def test_from_fen(fen, expected_pawn_number, expected_pawn_in_file):
    b = board.from_fen(fen)
    assert b.pawn_number == bytearray(expected_pawn_number)
    assert b.pawn_in_file == bytearray(expected_pawn_in_file)
...
def test_push_pawn(
    ...
    assert nb.pawn_number == bytearray(expected_pawn_number)
    assert nb.pawn_in_file == bytearray(expected_pawn_in_file)
